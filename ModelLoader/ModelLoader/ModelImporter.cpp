...
namespace {
	...
	void convertPMDToModelData(model::ModelData& _modelData, const model::pmd::PMDFile& _pmdFile) {
	...
	void convertPMXToModelData(model::ModelData& _modelData, const model::pmx::PMXFile& _pmxFile) {
...
model::ModelData& ModelImporter::getModelData(const std::string& _name)
{
